...
contract CoreSwapEddy is Ownable {

    uint16 internal constant MAX_DEADLINE = 200;
    uint256 public constant chainId = 1116;
    uint256 public slippage;
    // Sushi router Core
    address public constant sushiSwapRouter = 0x0389879e0156033202C44BF784ac18fC02edeE4f;
    ...
    constructor(uint256 _platformFee) {
        ...
        sushiSwap = ISushiSwap(sushiSwapRouter);
    ...
    function swapEddyTokensForTokens(
        ...
        // Give approval to sushi
        IERC20(tokenIn).approve(sushiSwapRouter, amountIn);

        uint256 amountOut = sushiSwap.processRoute(
            tokenIn,
            amountIn,
            tokenOut,
            amountOutMin,
    ...
    function swapEddyExactETHForTokens(
        ...
        // Swap all the Core
        uint256 amountOut = sushiSwap.processRoute{value: msg.value}(
            tokenIn,
            amountIn,
            tokenOut,
            amountOutMin,
